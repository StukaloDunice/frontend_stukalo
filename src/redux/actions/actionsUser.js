...
export const requestUser = (payload) => ({
  type: actionsTypes.USER_REQUEST, payload,
});

export const requestUserSuccess = (payload) => ({
  type: actionsTypes.USER_SUCCESS, payload,
});

export const requestUserError = (error) => ({
  type: actionsTypes.USER_ERROR, error,
});
...
export const editingUserError = (payload) => ({
  type: actionsTypes.EDITING_USER_ERROR, payload,
});
